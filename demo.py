...
DOLLY_V2_VERSION="12b"



generate_text = pipeline(model=f"databricks/dolly-v2-{DOLLY_V2_VERSION}", torch_dtype=torch.bfloat16,
...
jsons = glob.glob("/home/ubuntu/Table-Data/output_db/*json")[:1]
results = []
